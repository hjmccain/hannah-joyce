  ...
  return (
    <Layout>
      <p className="col-start-3 row-start-2 text-justify text-lg text-black md:m-4 md:text-2xl">
        ...
        of her work explores the edges, overlaps, and juxtapositions between the
        human and non-human, the “natural” and “artificial.” She is equal parts
        luddite and cyborg futurist.{" "}
        <a
